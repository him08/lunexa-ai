        ...
        <>
            <div className='bg-[#F5F5F5] h-full w-full flex-col '>
                <div className=' p-5 mt-3 flex row justify-between'>
                    <div className='text-xl font-medium'>My Meetings</div>
                    {/* NEW MEETING BUTTON */}
                    <div className=' mx-5 w-36 h-12 gap-2 bg-[#3BAC5D] flex justify-center items-center rounded-lg cursor-pointer hover:bg-green-600'>
                        <div><Plus size={20} color='white' /></div>
                        <div className='font-medium text-s text-white'>New Meeting</div>
                    </div>
                </div>
            ...
            <div className='flex justify-center items-center font-medium'>Create your first Meeting</div>
